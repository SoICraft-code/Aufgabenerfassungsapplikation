...
class TestTaskManager(unittest.TestCase):
    ...
    @patch('builtins.input', side_effect=[
        "Test Title",          # Input für die Suche nach der Aufgabe
        "0", "Test Title Updated", # Titel bearbeiten
        "1", "Test Description Updated", # Beschreibung bearbeiten
        "2", "01-01-2024", # Fälligkeitsdatum bearbeiten
        "3", "j", # Status bearbeiten
        "4"  # Beenden
    ])
